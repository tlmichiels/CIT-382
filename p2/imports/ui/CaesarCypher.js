...
export default class CaesarCypher extends Component {
	...
	doCaesarShift = () => {
        let encryptedText = handleMath(this.props.clearText, this.state.offsetNum, this.state.shiftLeft);
        return (
            <span>
                {encryptedText}
            </span>
		...
		return(
			<div className="container">
				<div>
                	...
                	<span className="labels">Shift Left:</span> <input type="checkbox" checked={this.state.shiftLeft} onChange={this.onChecked.bind(this)} />
            	</div>
            </div>
			);
	}
